...
const CONTROL_SECTIONS = [
  {
    title: 'Driving',
    fullWidth: true,
    intro: 'Rally drops you in the car ready to go. On foot, walk up to a vehicle and press E. Tune builds in Garage from Settings.',
    items: [
  ...
  },
  {
    ...
    items: [
      ...
      ['G (near enemy)', 'Grab & slam (unarmed / sheathed)'],
    ],
  },
  {
    title: 'Chop (Arc Cut)',
    intro: 'Choose a world-space cut angle in real time, then release to instantly slice everything in the surrounding arc.',
    items: [
      ['V (hold)', 'Show the live world-space arc'],
      ['A / D', 'Choose cut angle'],
      ['Release V', 'Instantly cut everything in range'],
      ['Esc', 'Cancel'],
    ],
  },
  {
    title: 'Abilities',
    intro: 'F activates the equipped ability (default: grapple swing). Holster weapons with Z to free hands for traversal powers. Cycle abilities via debug or equipAbility().',
    items: [
      ['F', 'Use equipped ability'],
      ['Swing equipped', 'F / middle-click fire grapple · Alt aim · double-tap F dual-hook yank · Space release'],
      ['Wingsuit equipped', 'F deploy / retract glider in the air (double-tap Space also works)'],
