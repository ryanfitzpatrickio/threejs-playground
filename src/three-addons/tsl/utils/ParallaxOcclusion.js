// ParallaxOcclusion.js — vendored from SkyeShark/threejs-silhouette-pom
// (https://github.com/SkyeShark/threejs-silhouette-pom), MIT licensed.
//
// A pure-TSL parallax occlusion mapping helper with silhouette clipping, curved
// silhouettes and horizon trimming. Pins three.js 0.185.1 — an exact match for
// this repo's r185 WebGPU/TSL build — and is submitted upstream as a three.js
// addon candidate (`three/addons/tsl/utils/ParallaxOcclusion.js`). When/if it
// lands upstream, swap this vendored copy for the addon import (same surface),
// mirroring the city-generator upstream-sync convention. Kept verbatim below so
// the upstream JSDoc (which documents the TSL pitfalls) stays intact.
